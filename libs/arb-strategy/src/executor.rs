use crate::monitor::MonitoredMarket;
use crate::risk::{RiskConfig, RiskManager};
use polymarket_client::{
    types::*, OrderType, PolymarketAuth, RestClient,
};
use std::sync::Arc;
use thiserror::Error;
...
pub enum ExecutorError {
    ...
    RestError(#[from] polymarket_client::rest::RestError),

    #[error("Risk check failed: {0}")]
    RiskError(#[from] crate::risk::RiskError),
