use crate::domain::strategy::{ExecutedTrade, ExecutorError, MonitoredMarket, TradingConfig};
...
// ExecutedTrade is now in domain::strategy
...
impl OrderExecutor {
    ...
    pub async fn try_execute(
        ...
        let response = self
            ...
            .await
            .map_err(|e| ExecutorError::from_rest_error(e))?;
